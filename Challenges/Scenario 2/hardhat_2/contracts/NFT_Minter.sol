...
contract Minter is ERC721Enumerable, ZKPVerifier {
    ...
    //Address => ZKPVerificationRequestID => Time verfied until
    ...
    function goodUser(address query) private view returns(bool) {
        return verifiedUntil[query][1] > block.timestamp;
    }
